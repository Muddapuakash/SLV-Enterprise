...
async function main() {
    ...
    // ADMIN USER
    // ============================================================
    const adminPassword = await argon2_1.default.hash('Admin@SV2024!');
    ...
    const projects = [
        {
            ...
            service: client_1.ServiceType.CABLING,
        ...
        },
        {
            ...
            service: client_1.ServiceType.CCTV,
        ...
        },
        {
            ...
            service: client_1.ServiceType.WIFI,
    ...
    // ============================================================
    const coverageAreas = [
        { area: 'Vijinapura', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.INTERNET, available: true },
        { area: 'Dooravani Nagar', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.INTERNET, available: true },
        { area: 'Vijinapura', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.WIFI, available: true },
        { area: 'Dooravani Nagar', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.WIFI, available: true },
        { area: 'Vijinapura', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.CCTV, available: true },
        { area: 'Dooravani Nagar', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.CCTV, available: true },
        { area: 'Vijinapura', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.CABLING, available: true },
        { area: 'Dooravani Nagar', city: 'Bangalore', pincode: '560016', serviceType: client_1.ServiceType.CABLING, available: true },
    ];
